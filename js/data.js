...
export const CATALOGUE = [
  /* ---- anime ---- */
  { id:'mushishi', t:'Mushishi', yr:2005, k:'anime', len:'46 ep', x:[.85,.25,.45,.80,.55,.60,.10,.10], adv:[],
  ...
  { id:'dungeonmeshi', t:'Delicious in Dungeon', yr:2024, k:'anime', len:'24 ep', x:[.40,.60,.35,.60,.35,.95,.55,.50], adv:[],
    why:'A dungeon crawl where the ecology is the actual subject. Every creature has a trophic level and every rule is obeyed.' },
  { id:'steinsgate', t:'Steins;Gate', yr:2011, k:'anime', len:'24 ep', x:[.65,.70,.55,.50,.75,.90,.45,.70], adv:[],
    why:'Time travel with a stated mechanism and a real price. Endure the first eight episodes; they are load-bearing.' },
  { id:'bebop', t:'Cowboy Bebop', yr:1998, k:'anime', len:'26 ep', x:[.70,.40,.60,.90,.60,.40,.75,.60], adv:['violence','music'],
    why:'Episodic, jazz-scored, and the reason the craft ceiling of the medium moved where it did.' },
  { id:'rakugo', t:'Shouwa Genroku Rakugo Shinjuu', yr:2016, k:'anime', len:'25 ep', x:[.95,.65,.70,.90,.80,.35,.15,.20], adv:['romance'],
  ...
  { id:'tt3d', t:'TT3D: Closer to the Edge', yr:2011, k:'doc', len:'104 min', x:[.60,.40,.70,.70,.80,.40,.95,.70], adv:['violence'],
    why:'The Isle of Man TT with the odds stated plainly by the men taking them. Guy Martin talking is the film.' },
  { id:'senna', t:'Senna', yr:2010, k:'doc', len:'106 min', x:[.75,.50,.60,.70,.80,.40,.85,.65], adv:[],
    why:'Archive footage only, no talking heads. A study in what conviction looks like from inside a helmet.' },
  { id:'onanysunday', t:'On Any Sunday', yr:1971, k:'doc', len:'96 min', x:[.40,.25,.20,.65,.20,.30,.85,.60], adv:[],
    why:'The film that made motorcycling look like joy rather than menace. It still works.' },
  { id:'longwayround', t:'Long Way Round', yr:2004, k:'doc', len:'10 ep', x:[.50,.35,.25,.40,.30,.30,.60,.40], adv:['language'],
    why:'London to New York on two bikes. The template every overland trip since has copied, mistakes included.' },
  { id:'alpinist', t:'The Alpinist', yr:2021, k:'doc', len:'92 min', x:[.85,.30,.70,.75,.85,.35,.80,.40], adv:[],
    why:'Marc-André Leclerc soloing, and refusing to perform it. The film about a man who does not want a film.' },
  { id:'planetearth2', t:'Planet Earth II', yr:2016, k:'doc', len:'6 ep', x:[.20,.40,.10,.95,.30,.60,.90,.40], adv:[],
    why:'The technical ceiling for the form. Watch the Cities episode last; it reframes the other five.' },

  /* ---- tv ---- */
  { id:'thewire', t:'The Wire', yr:2002, k:'tv', len:'5 seasons', x:[.60,.90,.95,.80,.80,.95,.30,.35], adv:['violence','language','drugs','sex'],
    why:'Institutions as the protagonist. Each season swaps which institution, and none of them can be fixed from inside.' },
  { id:'bettercallsaul', t:'Better Call Saul', yr:2015, k:'tv', len:'6 seasons', x:[.90,.60,.90,.95,.80,.60,.35,.30], adv:['violence','language'],
    why:'A man becoming the person he was always going to be, one defensible decision at a time. Better than its parent show.' },
  { id:'chernobyl', t:'Chernobyl', yr:2019, k:'tv', len:'5 ep', x:[.60,.75,.75,.85,.95,.90,.50,.60], adv:['violence','gore','language'],
  ...
  { id:'severance', t:'Severance', yr:2022, k:'tv', len:'2 seasons', x:[.80,.55,.70,.90,.70,.85,.35,.40], adv:[],
    why:'A workplace thriller whose premise is a philosophy problem about personal identity, taken seriously.' },
  { id:'andor', t:'Andor', yr:2022, k:'tv', len:'2 seasons', x:[.65,.65,.75,.85,.75,.75,.60,.45], adv:['violence'],
    why:'A show about the logistics and cost of resistance. Ignore the franchise; the writing is not franchise writing.' },
  { id:'dark', t:'Dark', yr:2017, k:'tv', len:'3 seasons', x:[.60,.85,.60,.80,.85,.95,.40,.50], adv:['sex','nudity','violence'],
    why:'The only time-travel story that closes every loop it opens. Take notes; it expects you to.' },
  { id:'shogun', t:'Shōgun', yr:2024, k:'tv', len:'10 ep', x:[.65,.70,.85,.85,.80,.70,.55,.45], adv:['violence','gore','sex'],
    why:'Politics conducted entirely through what people are allowed to say. Subtitled and better for it.' },
  { id:'thebureau', t:'The Bureau (Le Bureau des Légendes)', yr:2015, k:'tv', len:'5 seasons', x:[.75,.85,.90,.70,.75,.85,.30,.40], adv:['sex','violence'],
    why:'French DGSE. The most accurate espionage show made, and the least glamorous — which is the same fact.' },
  { id:'slowhorses', t:'Slow Horses', yr:2022, k:'tv', len:'4 seasons', x:[.60,.65,.60,.65,.45,.50,.40,.65], adv:['language','violence'],
    why:'MI5’s rejects. Six-hour seasons, no fat, and Jackson Lamb is a genuinely new character.' },
  { id:'theterror', t:'The Terror', yr:2018, k:'tv', len:'10 ep', x:[.70,.60,.70,.85,.95,.60,.40,.30], adv:['violence','gore'],
    why:'The Franklin expedition. Season one only. The horror is the command structure, not the thing on the ice.' },
  { id:'haltcatchfire', t:'Halt and Catch Fire', yr:2014, k:'tv', len:'4 seasons', x:[.90,.60,.65,.75,.65,.60,.20,.35], adv:['sex','language'],
    why:'Four people keep building the next thing and keep being early. The best show about ambition and its cost.' },
  { id:'detectorists', t:'Detectorists', yr:2014, k:'tv', len:'3 series', x:[.85,.30,.20,.70,.25,.20,.05,.05], adv:[],
